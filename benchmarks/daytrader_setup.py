...
def main():
	...
	if args.prereqs:
		cluster.for_each(daytrader.DayTraderHost.benchmark_prereqs, passwd=passwd, parallel=True)

	cluster.for_each(daytrader.DayTraderHost.benchmark_setup, args.db2_installer_path, build_db2=args.db2,
	                 tune=args.tune, scripts_only=args.scripts_only, clean=args.clean, prune=args.prune,
